...
const creatorBankAccountRoutes = require("./routes/creatorBankAccountRoutes");
...
app.use(apiPrefix + "/course-enrollments", courseEnrollmentRoutes);
app.use(apiPrefix + "/payments", paymentRoutes);
app.use(apiPrefix + "/creator-bank-accounts", creatorBankAccountRoutes);
...
app.use(apiPrefix + "/admin/courses/reports", courseReportRoutes);
app.use(apiPrefix + "/admin/instructors", instructorAdminRoutes);
app.use(apiPrefix + "/admin/lessons", adminLessonRoutes);
app.use(apiPrefix + "/admin/notifications", notificationAdminRoutes);

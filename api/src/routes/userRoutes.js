...
router.put('/profile/details', authenticateToken, userController.updateProfileDetails);     // PUT /api/v1/users/profile/details
router.put('/profile/settings', authenticateToken, userController.updateSettings);          // PUT /api/v1/users/profile/settings
router.post('/profile/avatar', authenticateToken, userController.uploadMiddleware, userController.uploadAvatar); // POST /api/v1/users/profile/avatar
router.put('/profile/password', authenticateToken, userController.changePassword);          // PUT /api/v1/users/profile/password
